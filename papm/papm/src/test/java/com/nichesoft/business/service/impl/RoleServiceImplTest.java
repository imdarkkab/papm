...
import com.nichesoft.test.RoleEntityFactoryForTest;
...
public class RoleServiceImplTest {
	...
	public void findAll() {
		...
		when(roleJpaRepository.findAll()).thenReturn(roleEntitys);
	...
	public void create() {
		...
		when(roleJpaRepository.findOne(role.getRoleId())).thenReturn(null);
	...
	public void createKOExists() {
		...
		RoleEntity roleEntity = roleEntityFactoryForTest.newRoleEntity();
		when(roleJpaRepository.findOne(role.getRoleId())).thenReturn(roleEntity);
	...
	public void update() {
		...
		when(roleJpaRepository.save(roleEntity)).thenReturn(roleEntitySaved);
	...
	public void delete() {
		...
		// Then
		verify(roleJpaRepository).delete(roleId);
